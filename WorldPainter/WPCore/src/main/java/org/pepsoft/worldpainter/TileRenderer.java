...
//        }
    ...
    public static final Layer TERRAIN_AS_LAYER = new Layer("org.pepsoft.synthetic.Terrain", "地表", "The terrain type of the surface", Layer.DataSize.NONE, 0) {
        @Override
    ...
    public static final Layer FLUIDS_AS_LAYER = new Layer("org.pepsoft.synthetic.Fluids", "水/熔岩", "Areas flooded with water or lava", Layer.DataSize.NONE, 0) {
        @Override
        public BufferedImage getIcon() {
            return ICON;
        }
