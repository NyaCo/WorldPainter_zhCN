...
public final class Constants {
    ...
    public static final String[] COLOUR_NAMES = {"白色", "橙色", "品红色", "淡蓝色", "黄色", "黄绿色", "粉红色",
    ...
    public static final String ID_CHEST        = "箱子";
    public static final String ID_VILLAGER     = "村民";
    public static final String ID_PLAYER       = "玩家";
    public static final String ID_SIGN         = "告示牌";
    public static final String ID_PAINTING     = "画";
    public static final String ID_AIRPORTAL    = "Airportal";
    public static final String ID_BEACON       = "信标";
    public static final String ID_CAULDRON     = "炼药锅";
    public static final String ID_COMPARATOR   = "红石比较器";
    public static final String ID_CONTROL      = "Control";
    public static final String ID_DLDETECTOR   = "DL探测铁轨";
    public static final String ID_DROPPER      = "投掷器";
    public static final String ID_ENCHANTTABLE = "附魔台";
    public static final String ID_ENDERCHEST   = "末地箱";
    public static final String ID_FLOWERPOT    = "花盆";
    public static final String ID_FURNACE      = "熔炉";
    public static final String ID_HOPPER       = "漏斗";
    public static final String ID_MOBSPAWNER   = "僵尸刷怪箱";
    public static final String ID_MUSIC        = "音乐";
    public static final String ID_PISTON       = "活塞";
    public static final String ID_RECORDPLAYER = "RecordPlayer";
    public static final String ID_SKULL        = "头颅";
    public static final String ID_TRAP         = "活板";
    public static final String ID_BANNER       = "旗帜";
    public static final String ID_STRUCTURE    = "结构";
    public static final String ID_SHULKER_BOX  = "潜影盒"; // TODO: really?
    ...
    public static final String MOTIVE_KEBAB           = "烤肉串";
    public static final String MOTIVE_AZTEC           = "阿兹特克";
    public static final String MOTIVE_ALBAN           = "阿尔巴尼亚人";
    public static final String MOTIVE_AZTEC2          = "阿兹特克2";
    public static final String MOTIVE_BOMB            = "炸弹";
    public static final String MOTIVE_PLANT           = "植物";
    public static final String MOTIVE_WASTELAND       = "荒地";
    public static final String MOTIVE_WANDERER        = "漫步者";
    public static final String MOTIVE_GRAHAM          = "格雷姆";
    public static final String MOTIVE_POOL            = "池塘";
    public static final String MOTIVE_COURBET         = "库尔贝";
    public static final String MOTIVE_SUNSET          = "日落";
    public static final String MOTIVE_SEA             = "大海";
    public static final String MOTIVE_CREEBET         = "Creebet";
    public static final String MOTIVE_MATCH           = "火柴";
    public static final String MOTIVE_BUST            = "半身像";
    public static final String MOTIVE_STAGE           = "舞台";
    public static final String MOTIVE_VOID            = "虚空";
    public static final String MOTIVE_SKULL_AND_ROSES = "头骨与玫瑰";
	public static final String MOTIVE_WITHER          = "凋灵";
    public static final String MOTIVE_FIGHTERS        = "比武者";
    public static final String MOTIVE_SKELETON        = "骷髅";
    public static final String MOTIVE_DONKEY_KONG     = "金刚";
    public static final String MOTIVE_POINTER         = "指针";
    public static final String MOTIVE_PIGSCENE        = "猪的头像";
    public static final String MOTIVE_SKULL           = "燃烧的头骨";
    ...
    /** 2x2 paintings */
    public static final String[] LARGE_PAINTINGS = {MOTIVE_MATCH, MOTIVE_BUST, MOTIVE_STAGE, MOTIVE_VOID, MOTIVE_SKULL_AND_ROSES, MOTIVE_WITHER};
