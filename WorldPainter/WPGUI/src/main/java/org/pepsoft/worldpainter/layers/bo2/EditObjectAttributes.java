...
public class EditObjectAttributes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        comboBoxCollisionMode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "不改变", "任何方块", "固体方块", "无" }));
        ...
        jLabel7.setText("替换地面方块：");
        jLabel7.setToolTipText("Determines whether existing underground blocks should be replaced by blocks from the object.");

        comboBoxUndergroundMode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "不改变", "总是", "如果模型方块是固体", "如果地面方块是空气方块" }));
        ...
        jLabel8.setText("生成位置：");

        checkBoxRandomRotation.setText("是否随机旋转和镜像反转");

        checkBoxOnSolidLand.setText("在土地上");

        checkBoxOnAir.setText("在空气");

        checkBoxOnWater.setText("在水面上");

        checkBoxUnderWater.setText("在水底");

        checkBoxUnderLava.setText("在熔岩底");

        checkBoxOnLava.setText("在熔岩面上");
        ...
        jLabel9.setText("叶子类方块的处理：");

        comboBoxLeafDecayMode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "不改变", "和导出时属性相同", "枯萎", "不会枯萎" }));

        checkBoxReplace.setText("替换为空气：");
