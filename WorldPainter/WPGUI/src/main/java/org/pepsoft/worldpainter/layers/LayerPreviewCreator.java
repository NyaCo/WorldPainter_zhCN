...
//            Layer layer = Caverns.INSTANCE;
    ...
    public static final Pattern STEPPED_ZERO_TO_FULL = new Pattern("100% - 0%（突变）") {
        @Override
        float getStrength(int x, int y) {
    ...
    public static final Pattern STEPPED_ZERO_TO_HALF = new Pattern("50% - 0%（突变）") {
        @Override
        float getStrength(int x, int y) {
    ...
    public static final Pattern CONSTANT_HALF_PLUS_GRADIENT_PLUS_HIGHLIGHT = new Pattern("50% - 50% - 0%（高亮处为100%）") {
        @Override
        float getStrength(int x, int y) {
