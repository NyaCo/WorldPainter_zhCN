...
public class CombinedLayerEditor extends AbstractLayerEditor<CombinedLayer> {
    ...
    public void setContext(LayerEditorContext context) {
        ...
        comboBoxTerrain.setRenderer(new TerrainListCellRenderer(colourScheme, "未选择"));
        comboBoxBiome.setRenderer(new BiomeListCellRenderer(colourScheme, customBiomeManager, "未选择"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("在这个界面设置你的混合覆盖层。");
