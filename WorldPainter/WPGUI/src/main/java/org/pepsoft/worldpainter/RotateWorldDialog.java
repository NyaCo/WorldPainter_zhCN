...
public class RotateWorldDialog extends WorldPainterDialog implements ProgressReceiver {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("选择一个旋转角度，点击旋转按钮以旋转这个世界：");
        ...
        jRadioButton1.setText("顺时针旋转90°");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("旋转180°");

        buttonGroup1.add(jRadioButton3);
        jRadioButton3.setText("逆时针旋转90°");

        jLabel2.setText("<html><em>这个操作无法撤销！</em></html>");

        jCheckBox1.setSelected(true);
        jCheckBox1.setText("同时旋转对应的天花板或地面");
