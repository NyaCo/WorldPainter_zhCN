...
//        }
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("感谢名单", jScrollPane1);
        ...
        jLabel2.setText("<html><font color=\"Red\"><center><b>声明</b></center>本汉化包由<font color=\"Blue\">【中华地形师协会】</font>及<font color=\"Orange\">【星核汉化组】</font>联合推<br>出，仅供学习和交流使用。任何人或组织不得将本品出售<br>或用作商业用途。严禁任何人或组织剽窃、整合以及重新<br>打包。欢迎转载，但请务必保留版权信息。</font></html>");

        jLabel3.setText("<html>程序&汉化：<font color=\"Orange\">幻想の喵</font>、<font color=\"Orange\">疯狂小瑞瑞</font><br> 翻译&校对：<font color=\"Blue\">SQwatermark</font>、<font color=\"Blue\">珀尔</font><br> 测试：<font color=\"Blue\">中华地形师协会的各位</font></html>");

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/pepsoft/worldpainter/resources/Alipay_162_162.png"))); // NOI18N

        jLabel5.setFont(new java.awt.Font("宋体", 2, 12)); // NOI18N
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/pepsoft/worldpainter/icons/information.png"))); // NOI18N
        jLabel5.setText("捐赠→");
        jLabel5.setToolTipText("提示：此处捐款是捐给星核汉化组而非WP作者！");
        ...
        jTabbedPane1.addTab("关于汉化", jPanel1);
