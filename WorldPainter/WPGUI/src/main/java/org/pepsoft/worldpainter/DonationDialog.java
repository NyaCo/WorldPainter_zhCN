...
public final class DonationDialog extends WorldPainterDialog {
    ...
    public DonationDialog(Window parent) {
        ...
        try {
            URL buttonURL = new URL("https://www.paypalobjects.com/zh_CN/i/btn/btn_donate_LG.gif");
    ...
    private void donate() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Paypal捐款页面已在你的浏览器打开。\n\n十分感谢您的捐款！", "十分感谢", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void alreadyDonated() {
        Configuration.getInstance().setDonationStatus(Configuration.DonationStatus.DONATED);
        JOptionPane.showMessageDialog(this, "十分感谢您的捐款！", "十分感谢", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void noThanks() {
        ...
        JOptionPane.showMessageDialog(this, "好的，没问题。我们不会再询问这个问题。\n如果你改变想法，你可以在“关于”界面捐款！", "没问题", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("感谢您使用WorldPainer！\n\nWorldpainer需要付出大量的努力来创建和维护。您可以免费继续使用它，但请考虑以4.95欧元的小额捐款提供帮助。");
