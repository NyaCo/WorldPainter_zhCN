            ...
            Dimension result = ProgressDialog.executeTask(this, new ProgressTask<Dimension>() {
                ...
                public String getName() {
                    if (radioButtonTerrain.isSelected()) {
                        return "正在用" + ((Terrain) comboBoxTerrain.getSelectedItem()).getName() + "填充";
                    } else if (radioButtonSetLayer.isSelected()) {
                        return "正在用" + ((Layer) comboBoxSetLayer.getSelectedItem()).getName() + "填充";
                    } else if (radioButtonClearLayer.isSelected()) {
                        return "正在清除" + ((Layer) comboBoxSetLayer.getSelectedItem()).getName();
                    } else if (radioButtonInvertLayer.isSelected()) {
                        return "正在反相" + ((Layer) comboBoxInvertLayer.getSelectedItem()).getName();
                    } else if (radioButtonBiome.isSelected()) {
                        return "正在用" + biomeHelper.getBiomeName((Integer) comboBoxBiome.getSelectedItem()) + "填充";
                    } else if (radioButtonResetBiomes.isSelected()) {
                        return "正在将生物群系重置为自动生物群系";
...
chunks:         for (int chunkX = 0; chunkX < TILE_SIZE; chunkX += 16) {
    ...
    private void initComponents() {
        ...
        radioButtonSetLayer.setText("覆盖覆盖层：");
        ...
        radioButtonResetBiomes.setText("将生物群系重置为自动生物群系");
        ...
        radioButtonClearLayer.setText("移除覆盖层：");
        ...
        radioButtonResetTerrain.setText("重置地表方块和覆盖层至初始状态");
        ...
        radioButtonTerrain.setText("在地表覆盖方块：");
        ...
        radioButtonResetWater.setText("重置所有的水和熔岩");
        ...
        radioButtonInvertLayer.setText("反相覆盖层：");
        ...
        radioButtonBiome.setText("覆盖生物群系：");
        ...
        radioButtonMakeBiomesPermanent.setText("将自动生物群系转为固定的生物群系");
        ...
        radioButtonAddToSelection.setText("添加到选区");
        ...
        jLabel3.setText("<html><u>整体改变高度/面积...</u></html>");
        ...
        jLabel5.setText("<html><u>旋转地图...</u></html>");
        ...
        jLabel7.setText("<html><u>整体位移...</u></html>");
