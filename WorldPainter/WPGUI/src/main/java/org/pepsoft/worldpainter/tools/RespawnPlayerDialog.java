...
public class RespawnPlayerDialog extends javax.swing.JDialog {
    ...
    private void respawn() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "玩家出生点已被重置");
            dispose();
        } catch (IOException e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("当死亡重生出错时，使用这个工具来重生一个单机世界的玩家。");

        jLabel3.setFont(jLabel3.getFont().deriveFont(jLabel3.getFont().getStyle() | java.awt.Font.BOLD));
        jLabel3.setText("请确保Minecraft没有在运行！");

        jLabel4.setText("选择这个世界的level.dat文件，并点击重生按钮来重生玩家：");
