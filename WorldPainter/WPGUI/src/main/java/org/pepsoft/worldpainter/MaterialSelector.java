...
//            panelProperties.add(Box.createGlue(), constraints);
    ...
    private void initComponents() {
        ...
        buttonAddProperty.setText("添加");
        buttonAddProperty.setToolTipText("添加属性");
        ...
        jLabel5.setText("<html><u>查看方块ID及数据值（中文Wiki）</u></html>");
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        try {
            ...
            throw new RuntimeException("Malformed URL exception while trying to open https://minecraft-zh.gamepedia.com/Java%E7%89%88%E6%95%B0%E6%8D%AE%E5%80%BC", e);
        }
