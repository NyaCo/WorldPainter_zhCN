...
//                    } else {
                        switch (lookAndFeel) {
                            ...
                            case DARK_NIMBUS:
                                ...
                                break;
                            case PGSLOOKANDFEEL:
                                laf = "com.pagosoft.plaf.PgsLookAndFeel";
                                break;
                            case ACRYL:
                            ...
                            case LUNA:
                                ...
                                break;
                            case MCWIN:
                                laf = "com.jtattoo.plaf.mcwin.McWinLookAndFeel";
                                break;
                            case MINT:
...
//                    }
            ...
            int textFontSize = myConfig.getFontSize();
            if (textFontSize < 12){
                textFontSize = 12;
                myConfig.setFontSize((Integer) textFontSize);
            }
            String textFont = myConfig.getFont();
            if (textFont == null){
                textFont = "微软雅黑";
                myConfig.setFont((String) textFont);
            }
            Font font = new Font(textFont, Font.PLAIN, textFontSize);
