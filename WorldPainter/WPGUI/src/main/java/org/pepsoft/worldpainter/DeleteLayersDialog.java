...
public class DeleteLayersDialog extends WorldPainterDialog {
    ...
    private void deleteSelectedLayers() {
        if (JOptionPane.showConfirmDialog(this, "你确定要删除" + jList1.getSelectedIndices().length + "覆盖层吗？", "确认删除", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html>以下覆盖层将会被删除。你可以单击你不想删除的覆盖层以取消选中：</html>");
