            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(ScriptRunner.this, e.getClass().getSimpleName() + " occurred (message: " + e.getMessage() + ")", "错误", JOptionPane.ERROR_MESSAGE));
                        ...
                        SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(ScriptRunner.this, sb.toString(), "错误", JOptionPane.ERROR_MESSAGE));
                    } catch (FileNotFoundException e) {
                        logger.error("FileNotFoundException occurred while executing " + scriptFileName, e);
                        SwingUtilities.invokeLater(() -> JOptionPane.showMessageDialog(ScriptRunner.this, "执行" + scriptFileName + "时未找到文件", "错误", JOptionPane.ERROR_MESSAGE));
                    } finally {
                        if (dimension != null) {
