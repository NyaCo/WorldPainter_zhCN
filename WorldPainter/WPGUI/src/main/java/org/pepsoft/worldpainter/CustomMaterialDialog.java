...
public class CustomMaterialDialog extends WorldPainterDialog {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("<html><u>查看方块ID及数据值（中文Wiki）</u></html>");
        ...
        jLabel4.setText("<html><u>查看方块ID及数据值（中文Wiki）</u></html>");
        ...
        buttonRemoveMaterial.setText("移除所选材质");
        ...
        jLabel7.setText("X轴方向倾斜：");

        jLabel3.setText("斑点规模：");
        ...
        radioButtonLayered.setText("分层模式");
        ...
        jLabel1.setText("为你的自定义地表选择方块ID以及数据值：");

        checkBoxLayeredRepeat.setSelected(true);
        checkBoxLayeredRepeat.setText("是否重复：");
        ...
        jTabbedPane1.addTab("高级", jPanel2);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        try {
            DesktopUtils.open(new URL("https://minecraft-zh.gamepedia.com/Java%E7%89%88%E6%95%B0%E6%8D%AE%E5%80%BC"));
        } catch (MalformedURLException e) {
            throw new RuntimeException("Malformed URL exception while trying to open https://minecraft-zh.gamepedia.com/Java版数据值", e);
        }
